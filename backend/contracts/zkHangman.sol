...
contract zkHangman {
    ...
    uint[] public guesses;
    uint[10] public characterHashes;
    uint[10] public revealedChars;
    ...
    // the host has to choose a word with at least a length of 4
    ...
    function playerGuess(uint _guess) external gameNotOver {
        ...
        require(_guess >= 0 && _guess <= 26, "invalid guess");
    ...
    // input[2] contains the character represented as an uint within the range 0-26
